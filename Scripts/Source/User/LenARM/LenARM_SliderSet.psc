...
SliderSet Function SliderSet_Constructor(int idxSet)
	;D.Log("SliderSet_Constructor: " + idxSet)
	...
	If (sliderSet.SliderName != "")
		...
		string[] names = Util.StringSplit(sliderSet.SliderName, "|")
		sliderSet.NumberOfSliderNames = names.Length

		If (sliderSet.UnequipSlot != "")
			string[] slots = Util.StringSplit(sliderSet.UnequipSlot, "|")
...
; LenARM:LenARM_HelperScript Function GetScript() global
; 	return (Game.GetFormFromFile(7901, "LenA_RadMorphing.esp") as Quest) as LenARM:LenARM_HelperScript
; EndFunction
